...
class Admin::UsersController < Admin::ApplicationController
  # when creating a new user ( new action)
  # when re-rendering the form if creating a user fails ( create action)
  # when editing a user ( edit action)
  # when rerendering the form if editing a user fails ( update action)
